...
<div
  class="absolute top-0 left-0 w-full bg-neutral-100 dark:bg-neutral-950 shadow-md flex flex-row justify-between items-center px-6 h-16 border-b border-[#b300e6] box-border z-50"
  role="banner"
